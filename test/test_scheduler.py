...
async def test_scheduler_register_accepts_three_second_expression(
    ...
    scheduler = SchedulerManager(connection=Mock(), queries=Mock())
...
async def test_schedule_clean_old(
    ...
    sm1 = SchedulerManager(connection=apgdriver, queries=Queries(apgdriver))
    ...
    sm2 = SchedulerManager(connection=apgdriver, queries=Queries(apgdriver))
    ...
    sm3 = SchedulerManager(connection=apgdriver, queries=Queries(apgdriver))
    ...
    sm4 = SchedulerManager(connection=apgdriver, queries=Queries(apgdriver))
...
async def test_multi_instance_single_task_execution(
    ...
    scheduler1 = SchedulerManager(connection=apgdriver, queries=Queries(apgdriver))
    scheduler2 = SchedulerManager(connection=apgdriver, queries=Queries(apgdriver))
