...
# -----------------------------------------------------------------------
# InMemoryRepository conformance
# -----------------------------------------------------------------------


def test_in_memory_has_queue_repository_methods() -> None:
    required = {
        "dequeue",
        "enqueue",
        "log_jobs",
...
def test_in_memory_has_schedule_repository_methods() -> None:
    required = {
        "insert_schedule",
        "fetch_schedule",
        "set_schedule_queued",
...
def test_in_memory_has_notification_methods() -> None:
    required = {"notify_entrypoint_rps", "notify_job_cancellation", "notify_health_check"}
    assert required <= set(dir(InMemoryRepository))


def test_in_memory_has_schema_management_methods() -> None:
    required = {
        "install",
        "uninstall",
        "upgrade",
