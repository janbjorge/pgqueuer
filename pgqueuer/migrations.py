...
def create_migrations_list() -> list[Migration]:
    ...
    migrations = [
        ...
        Migration(
            ...
            sql_generator=lambda: f"""CREATE {durability.queue_log_table} TABLE {settings.queue_table_log} (
        ...
        Migration(
            ...
            sql_generator=lambda: f"""CREATE {durability.statistics_table} TABLE {settings.statistics_table} (
        id SERIAL PRIMARY KEY,
        ...
        Migration(
            ...
            sql_generator=lambda: f"""CREATE UNIQUE INDEX {settings.statistics_table}_unique_count ON {settings.statistics_table} (
        priority,
        ...
        Migration(
            ...
            sql_generator=lambda: f"""CREATE {durability.schedules_table} TABLE {settings.schedules_table} (
        id SERIAL PRIMARY KEY,
