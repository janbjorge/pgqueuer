...
def default_executor_factory(
    entrypoint: str,
    expression: str,
    func: executors.AsyncCrontab,
) -> executors.AbstractScheduleExecutor:
    return executors.DefaultScheduleExecutor(entrypoint, expression, func)
...
class SchedulerManager:
    ...
    def schedule(
        ...
        executor_factory: Callable[
            [str, str, executors.AsyncCrontab],
            executors.AbstractScheduleExecutor,
        ...
        def register(func: executors.AsyncCrontab) -> executors.AsyncCrontab:
            self.registry[key] = executor_factory(entrypoint, expression, func)
            return func
