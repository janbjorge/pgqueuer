...
class Queries:
    ...
    eq: EnvironmentQueries = dataclasses.field(init=False)
    qq: QueryQueries = dataclasses.field(init=False)
    sq: ScheduleQueries = dataclasses.field(init=False)

    def __post__init__(self) -> None:
        self.eq = EnvironmentQueries(self.driver)
        self.qq = QueryQueries(self.driver)
        self.sq = ScheduleQueries(self.driver)
