...
class DBSettings(BaseSettings):
    ...
    # When True, `pgq upgrade` modernizes legacy int4 SERIAL id columns (issue
    # #671): widens them to BIGINT and swaps the owned SERIAL sequence for a
    # GENERATED BY DEFAULT AS IDENTITY sequence, matching a fresh install. Takes
    # an ACCESS EXCLUSIVE lock and rewrites each table; set False to skip it and
    # migrate out-of-band.
